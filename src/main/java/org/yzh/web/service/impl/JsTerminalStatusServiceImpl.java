...
@Service
public class JsTerminalStatusServiceImpl implements JsTerminalStatusService {

    private static final Logger log = LoggerFactory.getLogger(JsTerminalStatusServiceImpl.class.getSimpleName());
