 ...
 */
public class T8900_0900_content{
    ...
    @Field(index = 0, type = DataType.WORD, desc = "透传消息Id")
    public int getMsgId() {
        return msgId;
    }
    ...
    @Field(index = 2, type = DataType.WORD, desc = "扩展消息属性")
    ...
    @Field(index = 4, type = DataType.WORD, desc = "驾培包序号")
    ...
    @Field(index = 6, type = DataType.BYTES,length = 16,desc = "终端编号")
