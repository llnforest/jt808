 ...
 */
@Message({JT808.教练员登出应答})
public class T8900_0900_coach_logout_answer extends AbstractMessage<Header> {



    private int type = 0x13;
    private int msgId = 0x8102;
    ...
    public T8900_0900_coach_logout_answer() {
    }

    public T8900_0900_coach_logout_answer(String mobileNo, int serialNo) {
        super(new Header(Integer.parseInt(JT808.数据下行透传.substring(2),16), serialNo, mobileNo));
    }

    public T8900_0900_coach_logout_answer(int serialNo, String mobileNo) {
        super(new Header(Integer.parseInt(JT808.数据下行透传.substring(2),16), serialNo, mobileNo));
    }
    ...
    @Field(index = 28, type = DataType.BYTES,length = 16,desc = "教练员编号")
