 ...
 */
@Message({JT808.查询照片应答})
public class T8900_0900_photo_search_command_answer extends AbstractMessage<Header> {



    private int type = 0x13;
    private int msgId = 0x0302;
    ...
    public T8900_0900_photo_search_command_answer() {
    }

    public T8900_0900_photo_search_command_answer(String mobileNo, int serialNo) {
        super(new Header(Integer.parseInt(JT808.数据上行透传.substring(2),16), serialNo, mobileNo));
    }

    public T8900_0900_photo_search_command_answer(int serialNo, String mobileNo) {
        super(new Header(Integer.parseInt(JT808.数据上行透传.substring(2),16), serialNo, mobileNo));
    }
