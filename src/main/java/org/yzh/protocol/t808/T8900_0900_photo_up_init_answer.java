 ...
 */
@Message({JT808.照片上传初始化应答})
public class T8900_0900_photo_up_init_answer extends AbstractMessage<Header> {



    private int type = 0x13;
    private int msgId = 0x8305;
    ...
    public T8900_0900_photo_up_init_answer() {
    }
    public T8900_0900_photo_up_init_answer(String mobileNo, int serialNo) {
        super(new Header(Integer.parseInt(JT808.数据下行透传.substring(2),16), serialNo, mobileNo));
    }

    public T8900_0900_photo_up_init_answer(int serialNo, String mobileNo) {
        super(new Header(Integer.parseInt(JT808.数据下行透传.substring(2),16), serialNo, mobileNo));
    }
