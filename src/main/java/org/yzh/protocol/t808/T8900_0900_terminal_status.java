 ...
 */
@Message({JT808.设置禁训状态})
public class T8900_0900_terminal_status extends AbstractMessage<Header> {
    ...
    public T8900_0900_terminal_status() {
    }

    public T8900_0900_terminal_status(String mobileNo, int serialNo) {
        super(new Header(Integer.parseInt(JT808.数据下行透传.substring(2),16), serialNo, mobileNo));
    }

    public T8900_0900_terminal_status(int serialNo, String mobileNo) {
        super(new Header(Integer.parseInt(JT808.数据下行透传.substring(2),16), serialNo, mobileNo));
    }
    ...
    @Field(index = 27, type = DataType.BYTE, desc = "禁训状态")
    ...
    @Field(index = 28, type = DataType.BYTE, desc = "提示消息长度")
    ...
    @Field(index = 29, type = DataType.STRING, desc = "提示消息内容")
